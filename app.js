            ...
            <div className="component">
                ...
                <div className="cn-wrapper" id="cn-wrapper">
                    <ul>
                      ...
                      <li><Link to="/"><i className="ion ion-ios-wineglass-outline" aria-hidden="true"></i></Link></li>
                      <li><Link to="/"><i className="ion ion-ios-person-outline" aria-hidden="true"></i></Link></li>
                      <li><Link to="/"><i className="ion ion-ios-email-outline" aria-hidden="true"></i></Link></li>
                     </ul>
                </div>
